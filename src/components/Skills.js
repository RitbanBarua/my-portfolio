      ...
      <section>
        <div className='container' id='skills-container'>
          ...
          <div className="container" id='skills-img-container'>
            <div className='skills-img-wrapper reveal' id="html-img-wrapper">
              <img src={htmlLogo} alt="HTML5" />
              <div className="hover-container">HTML</div>
            </div>
            <div className='skills-img-wrapper reveal' id="css-img-wrapper">
              <img src={cssLogo} alt="CSS" />
              <div className="hover-container">CSS</div>
            </div>
            <div className='skills-img-wrapper reveal' id="js-img-wrapper">
              <img src={jsLogo} alt="JAVASCRIPT" />
              <div className="hover-container">Javascript</div>
            </div>
            <div className='skills-img-wrapper reveal' id="react-img-wrapper">
